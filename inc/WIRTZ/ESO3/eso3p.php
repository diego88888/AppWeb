...
function eso3p(){
    ...
    $query = "select * from PROFESORADO where CURSO like 'ESO3%'";
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Datos generales de 3ºESO</h1>
            </div>
            
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">Inicio</li>
                <li class="breadcrumb-item active">3ºESO</li>
          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="m-0">Datos 3ºESO.</h4><br><br>
